...
def pseudotime(
    ...
    # Localize
    from FISHspace.spatials.clustering import localization
    ...
    if run_knn:
        from FISHspace.pp import neighbors
    ...
    if use_sme:
        from FISHspace.spatials.morphology import adjust
    ...
    adata.uns["global_graph"]["graph"] = list(G.subgraph(c) for c in nx.connected_components(G)) #nx.to_scipy_sparse_array(G)
